    ...
    <div class="header">
      <el-row :gutter="10">
        <el-col :xs="12" :sm="12" :md="4">
            <div class="logo">
                <span class="logo_prefix">JK</span><span class="logo_suffix">backstage</span>
            </div>
        </el-col>
        <el-col :xs="12" :sm="12" :md="8">
          <div class="search">
            <el-input size="small" placeholder="请输入你想要的内容...">
                            ...
                            <el-dropdown-item v-for="dialog in dialogs" :key="dialog.time" divided>
                                <div class="pop-div">
                                    <span class="pop-image">
                                      <img :src="dialog.header" width="50px" alt=""/>
                                    </span>
                            ...
                            <el-dropdown-item v-for="task in tasks" :key="task.id" divided>
                                <div class="task-div">
                                    <span class="task-span task-tag">
                                      <el-tag tyep="danger" v-if="task.rank==1">紧急</el-tag>
                                      <el-tag tyep="warning" v-if="task.rank==2">重要</el-tag>
                                      <el-tag tyep="success" v-if="task.rank==3">正常</el-tag>
                                    </span>
        ...
        <el-col :xs="8" :sm="8" :md="2">
            <div class="user-header">
                <el-dropdown trigger="click" menu-align="start">
                  <img src="../../../static/images/b_header.jpg" width="50px" alt=""/>
                  <el-dropdown-menu slot="dropdown">
                      <el-dropdown-item>
